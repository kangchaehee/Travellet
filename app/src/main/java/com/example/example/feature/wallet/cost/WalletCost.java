package com.example.example.feature.wallet.cost;
...
public class WalletCost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), WalletCostInput.class);
    ...
    public void onClick(View view1){
        Intent intent = new Intent(this, WalletCostInput.class);
