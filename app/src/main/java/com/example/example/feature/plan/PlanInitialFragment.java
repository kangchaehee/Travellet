...
import com.example.example.feature.main.DeleteDialog;
import com.example.example.feature.plan.budget.PlanBudget;
import com.example.example.feature.plan.input.PlanInput;
import com.example.example.R;
import com.example.example.feature.plan.friend.WithFriends;
import com.example.example.feature.plan.place.PlaceSearch;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), PlanInput.class);
        ...
        calculation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getContext(), TravelBudgetCalculation.class);
        ...
        withFriends.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), WithFriends.class);
                startActivity(intent);
            }
        });
    ...
    class PlanSubAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            transText.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    tDialog = new PlanTransportDialog(getContext());
