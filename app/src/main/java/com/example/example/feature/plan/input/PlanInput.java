package com.example.example.feature.plan.input;
...
import com.example.example.feature.plan.select.PlaceSelect;
...
public class PlanInput extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        placeSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), PlaceSelect.class);
