        ...
        card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!cardState){
                    ...
                    //cash.setTextColor(getResources().getColor(R.color.blue, getTheme()));
                    ...
                    //card.setTextColor(getResources().getColor(R.color.blue, getTheme()));
                }
            }
        });
        ...
        cash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!cashState){
                    ...
                    //cash.setTextColor(getResources().getColor(R.color.white, getTheme()));
